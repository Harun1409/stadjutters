      ...
      <PanGestureHandler onGestureEvent={handleGesture}>
        <Animated.View style={[styles.menu, animatedStyle]}>
          ...
          <View style={styles.menuItems}>
            ...
            <View style={styles.menuItemDivider} />
            <View style={styles.menuItemRow}>
              <Icon size={25} name="wrench" color={'#7A3038'} style={styles.menuIcon} />
            ...
            <View style={styles.menuItemRow}>
              ...
              {session ? (
                <Link href="/login" onPress={closeMenu} style={styles.menuItem}>Account</Link>
              ) : (
                <Link href="/login" onPress={closeMenu} style={styles.menuItem}>Login</Link>
              )}
            </View>
            <View style={styles.menuItemDivider} />
          </View>
